...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/StitchAWSService/StitchAWSService.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/StitchCore/StitchCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/StitchCoreAWSService/StitchCoreAWSService.framework"
